...
import { ArrowLeft, ArrowRight, CheckCircle2, ChevronDown, Copy, LogOut, User, Wallet } from "lucide-react";
  ...
  return connected ? (
    <div className="relative">
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button
            variant="default"
            className="group relative overflow-hidden bg-[#d5a514] hover:bg-[#095435] font-medium px-4 py-2 rounded-lg hover:shadow-sm hover:shadow-black-900/10 focus:outline-none focus:ring-0 active:outline-none active:ring-0"
          >
        ...
        <DropdownMenuContent align="end" className="w-64 border-0 bg-[#2d2d33] shadow-2xl rounded-xl p-2">
          <div className="px-3 py-3 mb-2">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#d5a514] flex items-center justify-center shadow-lg">
                <User className="w-6 h-6 text-gray-300" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <span className="text-sm font-semibold text-slate-200 dark:text-slate-100">{user?.username}</span>
    ...
    <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
      <DialogTrigger asChild>
        <Button className="group relative overflow-hidden bg-[#d5a514] hover:bg-[#17513f] text-white font-semibold px-6 py-3 rounded-md transition-all">
          <div className="relative flex items-center gap-3">
            <div className="relative">
    ...
    <WalletItem wallet={wallet} onConnect={handleConnect}>
      <WalletItem.ConnectButton asChild>
        <Button
          size="lg"
          variant="outline"
          className="w-full gap-4 text-white bg-gray-900/95 border-[#d5a514]/70 hover:bg-[#d5a514]/50 hover:text-white"
        >
